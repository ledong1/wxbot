...
hNickname={'巫毒师 巴蒂斯特': ['巴蒂斯特','巴蒂'], '盲豹 格雷': ['盲豹', '格雷'],'鹰眼 凯思卓': ['鹰眼', '凯思卓'],'天使 奥达基': ['天使', '奥达基', '鸟人'],'机械战姬 阿尔法': ['机械战姬', '阿尔法'],'刀锋魅影 安卡': ['刀锋魅影', '安卡'],'护卫 亚丹': ['亚丹','亚当','二蛋'],'沙漠之鹰 伊德瑞': ['沙漠之鹰', '伊德瑞','沙鹰'],
 '花妖 佩兔': ['花妖', '佩兔'],
 '黑暗法师 萨缪尔': ['黑暗法师', '萨缪尔','口口尔'],
 '圣骑士 格瑞斯': ['圣骑士','格瑞斯'],
 '魔狼 福彻斯': ['魔狼', '福彻斯'],
 '战警 凯瑟琳': ['战警','凯瑟琳','女警'],
 '剑客 黑羽': ['剑客', '黑羽','bf'],
